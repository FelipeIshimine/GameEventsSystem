...
namespace ScriptableEventsSystem.Editor.Events
{
	internal class GameEventInspectorElement : VisualElement
	{
		...
		public GameEventInspectorElement()
		{
			Initialize();
		}

		public GameEventInspectorElement(BaseGameEvent selectedEvent)
		{
			Initialize();
			SetGameEvent(selectedEvent);
		}
		...
		public void SetGameEvent(BaseGameEvent selectedEvent)
		{
			...
			typeLabel.visible = parameterType != null;
